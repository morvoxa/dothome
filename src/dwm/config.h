...
static const char col_gray1[] = "#222222"; // Background bar
static const char col_gray2[] = "#000000"; // Border tidak aktif (Hitam)
static const char col_gray3[] = "#bbbbbb"; // Warna teks biasa
static const char col_gray4[] = "#eeeeee"; // Warna teks aktif
static const char col_red[] = "#ff0000";   // Border aktif (Merah)
...
static const char *const autostart[] = {
    "xrandr", "-s",   "1920x1080", "-r", "75", NULL, "xset",
    "r",      "rate", "200",       "35", NULL, NULL /* terminate */
};
