if vim.g.vscode then
    ...
    vim.g.mapleader = " "
    map("n","<leader>w",":lua require('vscode').action('workbench.action.files.save')<cr>:lua require('vscode').notify('Saved Succesfully')<cr>",{})
    ...
    vim.api.nvim_set_keymap('o', 'R', '<cmd>lua require("flash").treesitter_search()<CR>', { noremap = true, silent = true })
    vim.api.nvim_set_keymap('x', 'R', '<cmd>lua require("flash").treesitter_search()<CR>', { noremap = true, silent = true })
